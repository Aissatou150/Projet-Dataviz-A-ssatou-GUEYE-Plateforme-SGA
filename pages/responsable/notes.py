...
dash.register_page(__name__, path='/responsable/notes', title='notes — Responsable SGA')
                ...
                dbc.Tab(label="Télécharger template", tab_id="tab-dl", children=[
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Div(id="dl-feedback-resp", className="mt-3"),
                            dcc.Download(id="download-template-resp"),
                        ], className="card-body"),
                    ], className="card mt-3"),
                ]),
                ...
                dbc.Tab(label="Importer les notes", tab_id="tab-ul", children=[
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Div(id="upload-notes-feedback-resp", className="mt-3"),
                        ], className="card-body"),
                    ], className="card mt-3"),
                ]),
                ...
                dbc.Tab(label="Tableau des notes", tab_id="tab-tableau", children=[
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Div(id="notes-tableau-resp"),
...
@callback(
    Output("download-template-resp","data"), Output("dl-feedback-resp","children"),
...
@callback(
    Output("upload-notes-feedback-resp","children"),
...
@callback(
    Output("notes-tableau-resp","children"),
