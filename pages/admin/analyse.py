...
dash.register_page(__name__, path='/admin/analyse', title='Analyse — Admin SGA')
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        html.Div(dcc.Graph(id="graph-histo", config={"displayModeBar":False}), className="card-body"),
                    ], className="card"),
                ], width=12, lg=6, className="mb-4"),
                dbc.Col([
                    html.Div([
                        html.Div("Moyenne par matière", className="card-header"),
                        html.Div(dcc.Graph(id="graph-moy", config={"displayModeBar":False}), className="card-body"),
                    ], className="card"),
                ], width=12, lg=6, className="mb-4"),
            ]),
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        html.Div(dcc.Graph(id="graph-rate", config={"displayModeBar":False}), className="card-body"),
                    ], className="card"),
                ], width=12),
            ]),
        ], className="page-body"),
